...
public class shapeMedium3 extends GameActivity implements View.OnTouchListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shape_medium3);
        ...
        timer.setOnTimerFinishedListener(new TimerHelper.OnTimerFinishedListener() {
            ...
            public void onTimerFinished() {
                popup.showTimeout();
                SoundHelper sfx = new SoundHelper(shapeMedium3.this, R.raw.time_out, false);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(shapeMedium3.this, levelDifficulty.class));
            }
        });
                ...
                for (int[] pair : overlappingPairs) {
                    ...
                    if (!shapesBlankDone[secondIndex] && !shapesDone[firstIndex] && isViewOverlapping(shapes[firstIndex], blankShapes[secondIndex])) {
                        ...
                        if (areAllTrue(shapesDone)) {
                            ...
                            SoundHelper sfx = new SoundHelper(shapeMedium3.this, R.raw.level_complete, false);
